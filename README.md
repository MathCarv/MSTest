...
*  Visual Studio (versão 2012 ou superior) ou Visual Studio Code -> https://visualstudio.microsoft.com/pt-br/downloads/
* .NET Framework (versão 4.5 ou superior) -> https://dotnet.microsoft.com/en-us/download/dotnet-framework
